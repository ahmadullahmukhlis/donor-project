                ...
                {session?.user ? (
                  <>
                    ...
                    {pathUrl !== "/" || sticky ? (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-blood bg-opacity-100 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-20 hover:text-dark"
                      >
                        Sign Out
                      </button>
                    ) : (
                  ...
                  <>
                    {pathUrl !== "/" ? (
                      <>
                        ...
                        <Link
                          href="/signup"
                          className="rounded-lg bg-blood px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-blood/90 dark:bg-white/10 dark:hover:bg-white/20"
                        >
                          Sign Up
                        </Link>
                      </>
                      ...
                      <>
                        ...
                        <Link
                          ...
                          className={`rounded-lg px-6 py-3 text-base font-medium text-white duration-300 ease-in-out ${
                            sticky
                              ? "bg-blood hover:bg-blood/90 dark:bg-white/10 dark:hover:bg-white/20"
